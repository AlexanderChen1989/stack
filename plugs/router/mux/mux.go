...
// mux.Vars(request).
func (r *Router) ServeHTTP(ctx xcontext.Context, w http.ResponseWriter, req *http.Request) {
	if !r.skipClean {
...
func (r *Router) HandleFunc(path string, f func(xcontext.Context, http.ResponseWriter, *http.Request)) *Route {
