...
func TestSubrouterErrorHandling(t *testing.T) {
	...
	router := NewRouter()
	router.NotFoundHandler = HandlerFunc(func(ctx xcontext.Context, w http.ResponseWriter, r *http.Request) {
		superRouterCalled = true
	})
	subRouter := router.PathPrefix("/bign8").Subrouter()
	subRouter.NotFoundHandler = HandlerFunc(func(ctx xcontext.Context, w http.ResponseWriter, r *http.Request) {
		subRouterCalled = true
	})

	req, _ := http.NewRequest("GET", "http://localhost/bign8/was/here", nil)
	router.ServeHTTP(nil, NewRecorder(), req)
...
func TestKeepContext(t *testing.T) {
	func1 := func(ctx xcontext.Context, w http.ResponseWriter, r *http.Request) {}
...
func Test301Redirect(t *testing.T) {
	...
	func1 := func(ctx xcontext.Context, w http.ResponseWriter, r *http.Request) {}
	func2 := func(ctx xcontext.Context, w http.ResponseWriter, r *http.Request) {}
...
func TestSubrouterHeader(t *testing.T) {
	...
	func2 := func(xcontext.Context, http.ResponseWriter, *http.Request) {}
	...
	resp := NewRecorder()
	match.Handler.ServeHTTP(nil, resp, req)
